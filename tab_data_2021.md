...
1.	Email a CSV/Excel file with the dataset(s) to aaron.guzman@owasp.org
2.	Upload a CSV/Excel file to a "contribution folder" (coming soon)

Template examples can be found in GitHub: [https://github.com/owasp/www-project-internet-of-things-top-10](https://github.com/owasp/www-project-internet-of-things-top-10)
